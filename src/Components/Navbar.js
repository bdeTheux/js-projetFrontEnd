  ...
  if (user){
    ...
    <nav class="navbar">
      ...
      <ul class="navbar-nav menu-content">
        ...
        <li class="nav-item left" id="home">
          <a href="#" data-uri="/" class="nav-link paw">
...
function onclick() {
  if (user){
    if (navbarOn){
      ...
      setTimeout(function () { fadeOut('home'); }, 1600);
      navbarOn = false;
    }else{
      fadeIn('home');
      setTimeout(function () { fadeIn('profil');}, 400);
      setTimeout(function () { fadeIn('leaderboard'); }, 800);
      setTimeout(function () { fadeIn('achievements'); }, 1200);
      setTimeout(function () { fadeIn('about-us'); }, 1600);
      navbarOn = true;
    }
  }else{
    if (navbarOn) {
